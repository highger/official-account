...
import com.mgy.official.account.common.config.QRCodeConstant;
...
//下载文件保存路径
        ...
        try {
//使用JRIBvilderi对象用于设置请求参数
            URIBuilder urlBuilder = new URIBuilder(url);
            urlBuilder.addParameter("fileName", localFileName);
            HttpGet httpGet = new HttpGet(urlBuilder.build()); //执行请求
    ...
    public static String doPostByFile(String url, Map<String, String> map, String LocalFile, String
            fileParamName) {
        ...
        try {
            ...
            httpPost.setEntity(reqEntity); //发起请求并返回请求的响应
